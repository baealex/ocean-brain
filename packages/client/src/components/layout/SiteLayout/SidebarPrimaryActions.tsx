...
const captureIconWrapClassName =
    'inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[13px] bg-cta text-fg-on-filled';
...
const SidebarPrimaryActions = () => {
    ...
    return (
        <div className={rootClassName}>
            <button type="button" className={captureButtonClassName} onClick={() => onCreate()}>
                <span className={captureContentClassName}>
                    ...
                    <span className={captureTextWrapClassName}>
                        <Text variant="meta" weight="semibold" tracking="tight">
                            Capture
                        </Text>
