...
export const APP_ROUTE_PATHS = {
    ...
    SETTINGS_SEARCH_ROUTE: '/setting/search',
    SETTINGS_MCP_ROUTE: '/setting/mcp',
    SETTINGS_INTEGRATIONS_ROUTE: '/setting/integrations',
    SETTINGS_INTEGRATION_CONNECT_ROUTE: '/setting/integrations/connect',
    SETTINGS_INTEGRATION_DETAIL_ROUTE: '/setting/integrations/$connectionId',
    INTEGRATION_ROUTE: '/integrations/$connectionId',
