...
describe('getGraphTheme', () => {
    ...
    it('maps link colors for idle, connected, and dimmed states', () => {
        expect(getGraphLinkColor('light', {
            selectedNodeId: null,
            isConnected: false
