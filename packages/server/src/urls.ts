...
export const createApiRouter = (
    ...
    mcpAdminService: McpAdminApiService
) => Router()
    ...
    .get('/mcp-admin/status', requireSessionForWrite(authConfig), useAsync(views.createMcpAdminStatusHandler(mcpAdminService)))
    .post('/mcp-admin/enabled', requireSessionForWrite(authConfig), useAsync(views.createMcpAdminSetEnabledHandler(mcpAdminService)))
    .post('/mcp-admin/token/rotate', requireSessionForWrite(authConfig), useAsync(views.createMcpAdminRotateTokenHandler(mcpAdminService)))
    .post('/mcp-admin/token/revoke', requireSessionForWrite(authConfig), useAsync(views.createMcpAdminRevokeTokenHandler(mcpAdminService)))
