...
const LAYOUT_OPTIONS = [
    { value: 'narrow' as const, label: '좁게', description: '좁은 레이아웃으로 긴 글을 읽기 편하게' },
    { value: 'wide' as const, label: '넓게', description: '적당한 너비로 대부분의 콘텐츠에 적합' },
    { value: 'full' as const, label: '꽉 채우기', description: '화면을 최대한 활용' }
];
